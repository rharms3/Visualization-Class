...
var state_names;
var var_year;
var init_var_year = 2008;  // set a call to a subroutine and pass the year based on the selection???
...
async function init(var_year,initvar) {
 console.log("initvar after init call = " , initvar);
  //Prep and load data + Slider Initializaton
//async function load_prep_data()
//  {
    ...
    // Time for slider
  //  if (initvar == 1){
    var yearmin = d3.min(initfiltered,function(data) { return data.year});
    var yearmax = d3.max(initfiltered,function(data) { return data.year});
...
//    return(filtered);
//  }  // end FUnction prep data and slider
    ...
    d3.selectAll('circle')
     .on("mouseover", function(d){
       ...
       //Get this bar's x/y values, then augment for the tooltip
        ...
        var yPosition = parseFloat(d3.mouse(this)[1]+25);//+70;// - 29;
